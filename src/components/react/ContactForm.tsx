        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              {/* Snapchat */}
              <a
                href={`https://snapchat.com/add/${SITE.snapchat}`}
                target="_blank"
                rel="noopener"
                className="flex items-center gap-4 p-4 bg-charcoal border border-white/5 rounded-xl hover:border-yellow-400/30 transition-colors"
              >
                <div className="w-12 h-12 bg-yellow-400/10 rounded-lg flex items-center justify-center">
                  <svg className="w-6 h-6" viewBox="147.353 39.286 514.631 514.631" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                ...
                <div>
                  <p className="text-gray-400 text-sm">Snapchat</p>
                  <p className="text-white text-lg font-semibold">{SITE.snapchat}</p>
                </div>
              </a>
